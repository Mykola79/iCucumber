...
public class AddEmployee extends CommonMethods {
    ...
    public void user_enters_firstname_and_middlename_and_lastname() {
        ...
        sendText(addEmployeePage.firstNameTextBox, PropertyReader.getPropertyValue("firstname"));
        ...
        sendText(addEmployeePage.middleNameTextBox, PropertyReader.getPropertyValue("middlename"));

        //driver.findElement(By.id("lastName")).sendKeys(ConfigReader.getPropertyValue("lastname"));
        //WebElement lastNameTextBox = driver.findElement(By.id("lastName"));
        sendText(addEmployeePage.lastNameTextBox, PropertyReader.getPropertyValue("lastname"));
