...
public class DatabaseTestTwo {
    public static void main(String[] args) {
        ...
        try {
            ...
            /*ResultSetMetaData - object that contains information about the result information such as in the table
             how many columns are there, name of the columns, rows and numbers of rows
             */
